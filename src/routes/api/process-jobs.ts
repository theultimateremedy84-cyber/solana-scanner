...
// "pending" for > 30 seconds) and reprocesses them. Also handles jobs where
// collect() completed but the status update failed due to missing columns by
// using the same fallback strategy as the trigger.
//
// USAGE — two options:
//
