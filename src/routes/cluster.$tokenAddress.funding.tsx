        ...
        <main className="space-y-6 px-5 py-6 sm:px-8">
          ...
          <div className="rounded-md border border-border bg-surface">
                ...
                <tbody className="divide-y divide-border">
                  {links.map((l) => (
                    <tr key={l.signature} className="hover:bg-surface-2 transition-colors">
                      <td className="px-4 py-2.5 font-mono text-[10px] text-muted-foreground">{l.signature.slice(0, 12)}…</td>
                      ...
                      <td className="px-4 py-2.5 text-center">
                        <a
                          ...
                          title="View this token's live transfers on Solscan"
                        >
                          <ExternalLink className="size-3" />
                          View
                        </a>
            ...
            <div className="border-t border-border px-4 py-2 text-[10px] text-muted-foreground font-mono">
              Links open the token&apos;s live transfer history on Solscan
            </div>
          </div>
