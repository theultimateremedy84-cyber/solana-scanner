    ...
    <tr className="group border-t border-border/30 hover:bg-muted/20 transition-colors">
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-2">
          <Link
            ...
            className="font-mono text-xs text-foreground/80 hover:text-primary transition-colors underline decoration-dotted underline-offset-2"
            title={`View wallet profile for ${wallet.wallet_address}`}
          >
      ...
      <td className="px-4 py-3">
        <span
          ...
          title="Verified closed positions — exits with confirmed cost-basis and real SOL proceeds"
        >
          {wallet.verified_positions ?? wallet.closed_position_count ?? 0}
        </span>
      </td>
      ...
      <header className="border-b border-border/40">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 font-mono text-[10px] uppercase tracking-[0.16em] text-muted-foreground md:flex">
            ...
            <Link to="/discovery-quality" className="transition hover:text-foreground">Discovery QA</Link>
          </nav>
        </div>
      </header>
          ...
          <table className="w-full text-sm">
            <thead className="border-b border-border/40 bg-muted/30">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-[10px] uppercase tracking-widest text-muted-foreground" title="Verified closed positions — exits with confirmed cost-basis and real SOL proceeds">
                  Verified Pos.
                </th>
                <th className="px-4 py-3 text-left text-[10px] uppercase tracking-widest text-muted-foreground">
                  Realized PnL
