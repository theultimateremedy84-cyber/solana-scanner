...
// FIX (P3 #17): import IGNORED_PROGRAMS from canonical singleton.
import { IGNORED_PROGRAMS as _IGNORED_CANONICAL } from "@/lib/constants/ignored-programs";
...
// ---------------------------------------------------------------------------
// FIX (P3 #17): use canonical singleton (local copy removed).
const IGNORED_PROGRAMS = _IGNORED_CANONICAL;
