 ...
 */
const LONG_TAIL_SLOTS = 3; // raised from 2 to match new TOKENS_PER_RUN=10 (30% long-tail reservation)

/** Max wallets to enrich per token per tick (respects Helius rate limits). */
const WALLETS_PER_TOKEN = 25; // raised from 10 — audit 2026-07-08: clears 38k backlog in ~3 days vs 16
