...
// EXPORTED (test-only): allows the Vitest suite to exercise the retry /
// skip-null-snapshot logic directly with a mocked Supabase client and a
// mocked fetchTokenPrice, without needing to drive the full
// refreshOpenPositionPrices() pipeline. Not intended for use outside this
