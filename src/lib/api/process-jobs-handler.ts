...
//   This module exports a plain function that server.ts intercepts directly,
//   the same pattern used for /api/price-refresh and /api/enrich-wallets.
//
// WIRE-UP (already done in server.ts):
//   handleApiRoute() checks for /api/process-jobs and dispatches here.
// =============================================================================
