...
//   elite       — score ≥ 0.65 AND confidence ≥ 0.50
//   strong      — score ≥ 0.45 AND confidence ≥ 0.35
//   developing  — score ≥ 0.25
//   unproven    — score <  0.25
//   low_sample  — confidence < 0.30 (overrides tier label)
//
...
function deriveTier(score: number, confidence: number): string {
  ...
  if (confidence < 0.30) return "low_sample";
  if (score >= 0.65 && confidence >= 0.50) return "elite";
  if (score >= 0.45 && confidence >= 0.35) return "strong";
