...
export class PostLaunchWatcher {
  ...
  private static readonly MINT_ALERT_COOLDOWN_MS = 30_000;
  ...
  private getWsUrl(): string {
    // Helius Enhanced WebSocket (atlas-mainnet.helius-rpc.com) — Geyser-powered.
    // The standard mainnet.helius-rpc.com WebSocket silently suppresses logsNotifications
    // for high-volume programs on the free tier. atlas-mainnet delivers the same
    // logsSubscribe / accountSubscribe protocol at full throughput.
