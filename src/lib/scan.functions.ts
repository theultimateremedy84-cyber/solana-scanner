...
export const scanTokenLive = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }): Promise<ScanResult> => {
    ...
    const [authorityTransitioned, accountResized, metadataHijacked, pathObfuscated, cpiManipulation, stateHijack, developerHistory, atomicExploitCached, atomicExploitLive] = await Promise.all([
