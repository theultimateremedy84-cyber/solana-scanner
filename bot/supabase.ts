...
// Use native WebSocket if available (Node 22+), otherwise fall back to the
// `ws` package. This fixes Railway deployments running Node 18/20.
const wsImpl =
...
export const supabase = createClient(config.supabaseUrl, config.supabaseKey, {
  ...
  realtime: {
    transport: wsImpl as unknown as typeof WebSocket,
  },
});
